...
export default class BloqueoUsuarioRepository {
  ...
  getAllAsync = async () => {
    ...
    const sql = `SELECT id, id_usuario_bloqueador, id_usuario_bloqueado, motivo, activo, fecha_bloqueo FROM "BloqueosUsuarios" ORDER BY id DESC`;
    return await BD.query(sql);
  };

  getByIdAsync = async (id) => {
    console.log(`BloqueoUsuarioRepository.getByIdAsync(${id})`);
    const sql = `SELECT id, id_usuario_bloqueador, id_usuario_bloqueado, motivo, activo, fecha_bloqueo FROM "BloqueosUsuarios" WHERE id = $1`;
  ...
  getByParejaAsync = async (idBloqueador, idBloqueado) => {
    ...
    const sql = `SELECT id, id_usuario_bloqueador, id_usuario_bloqueado, motivo, activo, fecha_bloqueo FROM "BloqueosUsuarios" WHERE id_usuario_bloqueador = $1 AND id_usuario_bloqueado = $2`;
  ...
  createAsync = async (entity) => {
    ...
    const sql = `INSERT INTO "BloqueosUsuarios" (id_usuario_bloqueador, id_usuario_bloqueado, motivo, activo, fecha_bloqueo) VALUES ($1, $2, $3, COALESCE($4, true), $5) RETURNING id`;
  ...
  updateAsync = async (entity) => {
    ...
    const sql = `UPDATE "BloqueosUsuarios" SET id_usuario_bloqueador = $2, id_usuario_bloqueado = $3, motivo = $4, activo = $5, fecha_bloqueo = $6 WHERE id = $1`;
  ...
  deleteByIdAsync = async (id) => {
    ...
    const sql = `UPDATE "BloqueosUsuarios" SET activo = false WHERE id = $1`;
