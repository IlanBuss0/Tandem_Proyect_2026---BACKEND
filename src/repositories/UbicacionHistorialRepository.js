...
export default class UbicacionHistorialRepository {
  ...
  getAllAsync = async () => {
    ...
    const sql = `SELECT id, id_dispositivo, latitud, longitud, fecha_registro FROM "UbicacionesHistoriales" ORDER BY id DESC`;
    return await BD.query(sql);
  };

  getByIdAsync = async (id) => {
    console.log(`UbicacionHistorialRepository.getByIdAsync(${id})`);
    const sql = `SELECT id, id_dispositivo, latitud, longitud, fecha_registro FROM "UbicacionesHistoriales" WHERE id = $1`;
  ...
  getByDispositivoIdAsync = async (idDispositivo) => {
    ...
    const sql = `SELECT id, id_dispositivo, latitud, longitud, fecha_registro FROM "UbicacionesHistoriales" WHERE id_dispositivo = $1 ORDER BY id DESC`;
    return await BD.query(sql, [idDispositivo]);
  };

  createAsync = async (entity) => {
    console.log(`UbicacionHistorialRepository.createAsync(${JSON.stringify(entity)})`);
    const sql = `INSERT INTO "UbicacionesHistoriales" (id_dispositivo, latitud, longitud, fecha_registro) VALUES ($1, $2, $3, $4) RETURNING id`;
  ...
  updateAsync = async (entity) => {
    ...
    const sql = `UPDATE "UbicacionesHistoriales" SET id_dispositivo = $2, latitud = $3, longitud = $4, fecha_registro = $5 WHERE id = $1`;
  ...
  deleteByIdAsync = async (id) => {
    ...
    const sql = `DELETE FROM "UbicacionesHistoriales" WHERE id = $1`;
