...
export default class ReporteUsuarioRepository {
  ...
  getAllAsync = async () => {
    ...
    const sql = `SELECT id, id_usuario_reportante, id_usuario_reportado, id_mensaje, id_archivo, id_estado_reporte, motivo, detalle, fecha_reporte FROM reportes_usuarios ORDER BY id DESC`;
    return await BD.query(sql);
  };

  getByIdAsync = async (id) => {
    console.log(`ReporteUsuarioRepository.getByIdAsync(${id})`);
    const sql = `SELECT id, id_usuario_reportante, id_usuario_reportado, id_mensaje, id_archivo, id_estado_reporte, motivo, detalle, fecha_reporte FROM reportes_usuarios WHERE id = $1`;
    return await BD.queryOne(sql, [id]);
  };

  createAsync = async (entity) => {
    console.log(`ReporteUsuarioRepository.createAsync(${JSON.stringify(entity)})`);
    const sql = `INSERT INTO reportes_usuarios (id_usuario_reportante, id_usuario_reportado, id_mensaje, id_archivo, id_estado_reporte, motivo, detalle, fecha_reporte) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id`;
  ...
  updateAsync = async (entity) => {
    ...
    const sql = `UPDATE reportes_usuarios SET id_usuario_reportante = $2, id_usuario_reportado = $3, id_mensaje = $4, id_archivo = $5, id_estado_reporte = $6, motivo = $7, detalle = $8, fecha_reporte = $9 WHERE id = $1`;
  ...
  deleteByIdAsync = async (id) => {
    ...
    const sql = `DELETE FROM reportes_usuarios WHERE id = $1`;
