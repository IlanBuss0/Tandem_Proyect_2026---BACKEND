...
export default class ParticipanteChatRepository {
  ...
  getAllAsync = async () => {
    ...
    const sql = `SELECT id, id_chat, id_usuario, fecha_ingreso, fecha_salida, ultimo_mensaje_leido_id, fecha_ultima_lectura, oculto_desde FROM participantes_chats ORDER BY id DESC`;
  ...
  getByIdAsync = async (id) => {
    ...
    await this.ensureExtraColumnsAsync();
    const sql = `SELECT id, id_chat, id_usuario, fecha_ingreso, fecha_salida, ultimo_mensaje_leido_id, fecha_ultima_lectura, oculto_desde FROM participantes_chats WHERE id = $1`;
  ...
  getByChatIdAsync = async (idChat) => {
    ...
    await this.ensureExtraColumnsAsync();
    const sql = `SELECT id, id_chat, id_usuario, fecha_ingreso, fecha_salida, ultimo_mensaje_leido_id, fecha_ultima_lectura, oculto_desde FROM participantes_chats WHERE id_chat = $1 ORDER BY id DESC`;
  ...
  getByChatAndUsuarioAsync = async (idChat, idUsuario) => {
    ...
    await this.ensureExtraColumnsAsync();
    const sql = `SELECT id, id_chat, id_usuario, fecha_ingreso, fecha_salida, ultimo_mensaje_leido_id, fecha_ultima_lectura, oculto_desde FROM participantes_chats WHERE id_chat = $1 AND id_usuario = $2`;
  ...
  createAsync = async (entity) => {
    ...
    await this.ensureExtraColumnsAsync();
    const sql = `INSERT INTO participantes_chats (id_chat, id_usuario, fecha_ingreso, fecha_salida, oculto_desde) VALUES ($1, $2, $3, $4, $5) RETURNING id`;
