...
export default class ConfiguracionUsuarioRepository {
  ...
  getAllAsync = async () => {
    ...
    const sql = `SELECT id, id_usuario, clave, valor, fecha_modificacion FROM configuraciones_usuarios ORDER BY id DESC`;
    return await BD.query(sql);
  };

  getByIdAsync = async (id) => {
    console.log(`ConfiguracionUsuarioRepository.getByIdAsync(${id})`);
    const sql = `SELECT id, id_usuario, clave, valor, fecha_modificacion FROM configuraciones_usuarios WHERE id = $1`;
    return await BD.queryOne(sql, [id]);
  };

  getByUsuarioIdAsync = async (idUsuario) => {
    console.log(`ConfiguracionUsuarioRepository.getByUsuarioIdAsync(${idUsuario})`);
    const sql = `SELECT id, id_usuario, clave, valor, fecha_modificacion FROM configuraciones_usuarios WHERE id_usuario = $1 ORDER BY clave ASC`;
  ...
  getByUsuarioAndClaveAsync = async (idUsuario, clave) => {
    ...
    const sql = `SELECT id, id_usuario, clave, valor, fecha_modificacion FROM configuraciones_usuarios WHERE id_usuario = $1 AND clave = $2`;
  ...
  createAsync = async (entity) => {
    ...
    const sql = `INSERT INTO configuraciones_usuarios (id_usuario, clave, valor, fecha_modificacion) VALUES ($1, $2, $3, $4) RETURNING id`;
  ...
  updateAsync = async (entity) => {
    ...
    const sql = `UPDATE configuraciones_usuarios SET id_usuario = $2, clave = $3, valor = $4, fecha_modificacion = $5 WHERE id = $1`;
  ...
  deleteByIdAsync = async (id) => {
    ...
    const sql = `DELETE FROM configuraciones_usuarios WHERE id = $1`;
