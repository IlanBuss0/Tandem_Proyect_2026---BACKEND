...
const router = Router();
const currentService = new DificultadActividadService();

router.get('', async (req, res) => {
  try {
    console.log('DificultadActividadController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`DificultadActividadController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('DificultadActividadController.create');

    const entity = new DificultadActividad(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`DificultadActividadController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`DificultadActividadController.delete(${id})`);
