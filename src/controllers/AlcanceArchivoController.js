...
const router = Router();
const currentService = new AlcanceArchivoService();

router.get('', async (req, res) => {
  try {
    console.log('AlcanceArchivoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`AlcanceArchivoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('AlcanceArchivoController.create');

    const entity = new AlcanceArchivo(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`AlcanceArchivoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`AlcanceArchivoController.delete(${id})`);
