...
const router = Router();
const currentService = new EstadoPagoService();

router.get('', async (req, res) => {
  try {
    console.log('EstadoPagoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoPagoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('EstadoPagoController.create');

    const entity = new EstadoPago(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoPagoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoPagoController.delete(${id})`);
