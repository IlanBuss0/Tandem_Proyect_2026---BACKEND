...
const router = Router();
const currentService = new CatalogoPermisoProfesionalService();

router.get('', async (req, res) => {
  try {
    console.log('CatalogoPermisoProfesionalController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`CatalogoPermisoProfesionalController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('CatalogoPermisoProfesionalController.create');

    const entity = new CatalogoPermisoProfesional(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`CatalogoPermisoProfesionalController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`CatalogoPermisoProfesionalController.delete(${id})`);
