...
router.get('', async (req, res) => {
  try {
    console.log('PermisoOtorgadoProfesionalController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`PermisoOtorgadoProfesionalController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('PermisoOtorgadoProfesionalController.create');
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`PermisoOtorgadoProfesionalController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`PermisoOtorgadoProfesionalController.delete(${id})`);
