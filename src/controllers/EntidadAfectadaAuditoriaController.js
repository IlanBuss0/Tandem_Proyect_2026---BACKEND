...
const router = Router();
const currentService = new EntidadAfectadaAuditoriaService();

router.get('', async (req, res) => {
  try {
    console.log('EntidadAfectadaAuditoriaController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`EntidadAfectadaAuditoriaController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('EntidadAfectadaAuditoriaController.create');

    const entity = new EntidadAfectadaAuditoria(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`EntidadAfectadaAuditoriaController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`EntidadAfectadaAuditoriaController.delete(${id})`);
