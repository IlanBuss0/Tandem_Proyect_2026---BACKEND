...
const router = Router();
const currentService = new TipoActividadService();

router.get('', async (req, res) => {
  try {
    console.log('TipoActividadController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoActividadController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('TipoActividadController.create');

    const entity = new TipoActividad(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoActividadController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoActividadController.delete(${id})`);
