...
const router = Router();
const currentService = new TipoUsuarioService();

router.get('', async (req, res) => {
  try {
    console.log('TipoUsuarioController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoUsuarioController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('TipoUsuarioController.create');

    const entity = new TipoUsuario(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoUsuarioController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoUsuarioController.delete(${id})`);
