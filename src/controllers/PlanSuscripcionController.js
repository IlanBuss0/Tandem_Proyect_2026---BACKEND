...
const router = Router();
const currentService = new PlanSuscripcionService();

router.get('', async (req, res) => {
  try {
    console.log('PlanSuscripcionController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`PlanSuscripcionController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('PlanSuscripcionController.create');

    const entity = new PlanSuscripcion(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`PlanSuscripcionController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`PlanSuscripcionController.delete(${id})`);
