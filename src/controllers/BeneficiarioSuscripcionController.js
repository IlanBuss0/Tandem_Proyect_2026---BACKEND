...
const router = Router();
const currentService = new BeneficiarioSuscripcionService();

router.get('', async (req, res) => {
  try {
    console.log('BeneficiarioSuscripcionController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`BeneficiarioSuscripcionController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('BeneficiarioSuscripcionController.create');

    const entity = new BeneficiarioSuscripcion(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`BeneficiarioSuscripcionController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`BeneficiarioSuscripcionController.delete(${id})`);
