...
const router = Router();
const currentService = new CatalogoPermisoPertenecienteService();

router.get('', async (req, res) => {
  try {
    console.log('CatalogoPermisoPertenecienteController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`CatalogoPermisoPertenecienteController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('CatalogoPermisoPertenecienteController.create');

    const entity = new CatalogoPermisoPerteneciente(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`CatalogoPermisoPertenecienteController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`CatalogoPermisoPertenecienteController.delete(${id})`);
