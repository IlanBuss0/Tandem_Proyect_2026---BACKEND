...
const router = Router();
const currentService = new EstadoActividadService();

router.get('', async (req, res) => {
  try {
    console.log('EstadoActividadController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoActividadController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('EstadoActividadController.create');

    const entity = new EstadoActividad(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoActividadController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoActividadController.delete(${id})`);
