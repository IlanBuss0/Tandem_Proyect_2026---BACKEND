...
router.get('', async (req, res) => {
  try {
    console.log('ArchivoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`ArchivoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('ArchivoController.create');
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`ArchivoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`ArchivoController.delete(${id})`);
