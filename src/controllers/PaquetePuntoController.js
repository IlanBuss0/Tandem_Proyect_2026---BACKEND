...
router.get('', async (req, res) => {
  try {
    console.log('PaquetePuntoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`PaquetePuntoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('PaquetePuntoController.create');
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`PaquetePuntoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`PaquetePuntoController.delete(${id})`);
