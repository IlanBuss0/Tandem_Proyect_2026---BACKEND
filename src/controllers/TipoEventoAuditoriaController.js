...
const router = Router();
const currentService = new TipoEventoAuditoriaService();

router.get('', async (req, res) => {
  try {
    console.log('TipoEventoAuditoriaController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoEventoAuditoriaController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('TipoEventoAuditoriaController.create');

    const entity = new TipoEventoAuditoria(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoEventoAuditoriaController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoEventoAuditoriaController.delete(${id})`);
