...
const router = Router();
const currentService = new PagoSuscripcionService();

router.get('', async (req, res) => {
  try {
    console.log('PagoSuscripcionController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`PagoSuscripcionController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('PagoSuscripcionController.create');

    const entity = new PagoSuscripcion(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`PagoSuscripcionController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`PagoSuscripcionController.delete(${id})`);
