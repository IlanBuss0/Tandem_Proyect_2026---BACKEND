...
const router = Router();
const currentService = new MensajeArchivoService();

router.get('', async (req, res) => {
  try {
    console.log('MensajeArchivoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`MensajeArchivoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('MensajeArchivoController.create');

    const entity = new MensajeArchivo(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`MensajeArchivoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`MensajeArchivoController.delete(${id})`);
