...
const router = Router();
const currentService = new EstadoValidacionProfesionalService();

router.get('', async (req, res) => {
  try {
    console.log('EstadoValidacionProfesionalController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoValidacionProfesionalController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('EstadoValidacionProfesionalController.create');

    const entity = new EstadoValidacionProfesional(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoValidacionProfesionalController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoValidacionProfesionalController.delete(${id})`);
