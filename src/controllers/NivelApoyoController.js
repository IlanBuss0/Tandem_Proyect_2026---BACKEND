...
const router = Router();
const currentService = new NivelApoyoService();

router.get('', async (req, res) => {
  try {
    console.log('NivelApoyoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`NivelApoyoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('NivelApoyoController.create');

    const entity = new NivelApoyo(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`NivelApoyoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`NivelApoyoController.delete(${id})`);
