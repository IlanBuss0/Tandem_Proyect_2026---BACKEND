...
router.get('', async (req, res) => {
  try {
    console.log('PuntoOtorgadoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`PuntoOtorgadoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('PuntoOtorgadoController.create');
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`PuntoOtorgadoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`PuntoOtorgadoController.delete(${id})`);
