...
router.get('', async (req, res) => {
  try {
    console.log('PerfilProfesionalController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`PerfilProfesionalController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('PerfilProfesionalController.create');
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`PerfilProfesionalController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`PerfilProfesionalController.delete(${id})`);
