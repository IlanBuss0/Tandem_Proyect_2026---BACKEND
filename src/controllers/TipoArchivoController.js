...
const router = Router();
const currentService = new TipoArchivoService();

router.get('', async (req, res) => {
  try {
    console.log('TipoArchivoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoArchivoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('TipoArchivoController.create');

    const entity = new TipoArchivo(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoArchivoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoArchivoController.delete(${id})`);
