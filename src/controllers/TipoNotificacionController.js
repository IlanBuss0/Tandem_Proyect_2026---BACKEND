...
const router = Router();
const currentService = new TipoNotificacionService();

router.get('', async (req, res) => {
  try {
    console.log('TipoNotificacionController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoNotificacionController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('TipoNotificacionController.create');

    const entity = new TipoNotificacion(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoNotificacionController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoNotificacionController.delete(${id})`);
