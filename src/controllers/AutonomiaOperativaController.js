...
const router = Router();
const currentService = new AutonomiaOperativaService();

router.get('', async (req, res) => {
  try {
    console.log('AutonomiaOperativaController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`AutonomiaOperativaController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('AutonomiaOperativaController.create');

    const entity = new AutonomiaOperativa(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`AutonomiaOperativaController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`AutonomiaOperativaController.delete(${id})`);
