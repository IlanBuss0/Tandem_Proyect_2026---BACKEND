...
import ValidacionProfesional from '../entities/ValidacionProfesional.js';
...
router.get('', async (req, res) => {
  try {
    console.log('ValidacionProfesionalController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`ValidacionProfesionalController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('ValidacionProfesionalController.create');

    const entity = new ValidacionProfesional(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`ValidacionProfesionalController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`ValidacionProfesionalController.delete(${id})`);
