...
const router = Router();
const currentService = new EstadoVinculoService();

router.get('', async (req, res) => {
  try {
    console.log('EstadoVinculoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoVinculoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('EstadoVinculoController.create');

    const entity = new EstadoVinculo(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoVinculoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoVinculoController.delete(${id})`);
