...
const router = Router();
const currentService = new EstadoReporteService();

router.get('', async (req, res) => {
  try {
    console.log('EstadoReporteController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoReporteController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('EstadoReporteController.create');

    const entity = new EstadoReporte(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoReporteController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoReporteController.delete(${id})`);
