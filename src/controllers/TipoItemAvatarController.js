...
const router = Router();
const currentService = new TipoItemAvatarService();

router.get('', async (req, res) => {
  try {
    console.log('TipoItemAvatarController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoItemAvatarController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('TipoItemAvatarController.create');

    const entity = new TipoItemAvatar(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoItemAvatarController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoItemAvatarController.delete(${id})`);
