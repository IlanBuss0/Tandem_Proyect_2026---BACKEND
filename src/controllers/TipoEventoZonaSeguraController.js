...
const router = Router();
const currentService = new TipoEventoZonaSeguraService();

router.get('', async (req, res) => {
  try {
    console.log('TipoEventoZonaSeguraController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoEventoZonaSeguraController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('TipoEventoZonaSeguraController.create');

    const entity = new TipoEventoZonaSegura(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoEventoZonaSeguraController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoEventoZonaSeguraController.delete(${id})`);
