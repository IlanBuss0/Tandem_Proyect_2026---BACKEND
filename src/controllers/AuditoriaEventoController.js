...
const router = Router();
const currentService = new AuditoriaEventoService();

router.get('', async (req, res) => {
  try {
    console.log('AuditoriaEventoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`AuditoriaEventoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('AuditoriaEventoController.create');

    const entity = new AuditoriaEvento(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`AuditoriaEventoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`AuditoriaEventoController.delete(${id})`);
