...
router.get('', async (req, res) => {
  try {
    console.log('HistorialPermisoOtorgadoPertenecienteController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`HistorialPermisoOtorgadoPertenecienteController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('HistorialPermisoOtorgadoPertenecienteController.create');
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`HistorialPermisoOtorgadoPertenecienteController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`HistorialPermisoOtorgadoPertenecienteController.delete(${id})`);
