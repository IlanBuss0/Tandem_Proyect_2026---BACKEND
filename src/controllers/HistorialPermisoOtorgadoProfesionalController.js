...
router.get('', async (req, res) => {
  try {
    console.log('HistorialPermisoOtorgadoProfesionalController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`HistorialPermisoOtorgadoProfesionalController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('HistorialPermisoOtorgadoProfesionalController.create');
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`HistorialPermisoOtorgadoProfesionalController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`HistorialPermisoOtorgadoProfesionalController.delete(${id})`);
