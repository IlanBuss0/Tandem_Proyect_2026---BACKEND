...
router.get('', async (req, res) => {
  try {
    console.log('VinculoProfesionalPertenecienteController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`VinculoProfesionalPertenecienteController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('VinculoProfesionalPertenecienteController.create');
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`VinculoProfesionalPertenecienteController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`VinculoProfesionalPertenecienteController.delete(${id})`);
