...
const router = Router();
const currentService = new TipoChatService();

router.get('', async (req, res) => {
  try {
    console.log('TipoChatController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoChatController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('TipoChatController.create');

    const entity = new TipoChat(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoChatController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoChatController.delete(${id})`);
