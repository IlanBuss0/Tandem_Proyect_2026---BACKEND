...
const router = Router();
const currentService = new TipoMovimientoPuntoService();

router.get('', async (req, res) => {
  try {
    console.log('TipoMovimientoPuntoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoMovimientoPuntoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('TipoMovimientoPuntoController.create');

    const entity = new TipoMovimientoPunto(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoMovimientoPuntoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoMovimientoPuntoController.delete(${id})`);
