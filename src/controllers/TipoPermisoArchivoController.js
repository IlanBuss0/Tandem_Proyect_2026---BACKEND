...
const router = Router();
const currentService = new TipoPermisoArchivoService();

router.get('', async (req, res) => {
  try {
    console.log('TipoPermisoArchivoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoPermisoArchivoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('TipoPermisoArchivoController.create');

    const entity = new TipoPermisoArchivo(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoPermisoArchivoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`TipoPermisoArchivoController.delete(${id})`);
