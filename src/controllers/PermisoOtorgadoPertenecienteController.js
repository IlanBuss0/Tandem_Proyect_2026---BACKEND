...
router.get('', async (req, res) => {
  try {
    console.log('PermisoOtorgadoPertenecienteController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`PermisoOtorgadoPertenecienteController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('PermisoOtorgadoPertenecienteController.create');
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`PermisoOtorgadoPertenecienteController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`PermisoOtorgadoPertenecienteController.delete(${id})`);
