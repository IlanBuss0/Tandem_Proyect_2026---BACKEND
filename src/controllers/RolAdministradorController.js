...
const router = Router();
const currentService = new RolAdministradorService();

router.get('', async (req, res) => {
  try {
    console.log('RolAdministradorController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`RolAdministradorController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('RolAdministradorController.create');

    const entity = new RolAdministrador(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`RolAdministradorController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`RolAdministradorController.delete(${id})`);
