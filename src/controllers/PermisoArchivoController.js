...
const router = Router();
const currentService = new PermisoArchivoService();

router.get('', async (req, res) => {
  try {
    console.log('PermisoArchivoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`PermisoArchivoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('PermisoArchivoController.create');

    const entity = new PermisoArchivo(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`PermisoArchivoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`PermisoArchivoController.delete(${id})`);
