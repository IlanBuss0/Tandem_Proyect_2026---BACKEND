...
const router = Router();
const currentService = new EstadoContactoService();

router.get('', async (req, res) => {
  try {
    console.log('EstadoContactoController.getAll');
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoContactoController.getById(${id})`);
...
router.post('', async (req, res) => {
  try {
    console.log('EstadoContactoController.create');

    const entity = new EstadoContacto(req.body);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoContactoController.update(${id})`);
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.log(`EstadoContactoController.delete(${id})`);
