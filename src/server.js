...
import { startInactivePatientWorker } from './workers/inactivePatientWorker.js';
...
app.use('/api', verifiedAccountMiddleware);
...
app.use('/api/eventos-calendario', CalendarEventController);
app.use('/api/rutinas', RoutineController);
